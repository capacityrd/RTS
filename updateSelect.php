  ...
  <div id="cargando" style="position: absolute; left: 0; top: 0; width: 100%; height: 100%; z-index:100000; background-color:white">
	...
	<div class="container-fluid" id="txtHint">
		...
		<?php
			...
			$result = mysqli_query($conexion, "select * from RTS WHERE status = 1 order by channelNumber asc");
			while ($reg=mysqli_fetch_array($result)){
				...
				echo "<div class='item ".getBackColor($reg['block'])."' onclick=window.open('updateChannel.php?q=".$reg['ID']."')>";
